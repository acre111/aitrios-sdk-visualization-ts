...
See the "Issuing a Client Secret for SDK" in https://developer.aitrios.sony-semicon.com/en/file/download/portal-user-manual["**Portal User Manual**"] for more information.
*** Client ID
*** Secret
+
...
To set up Codespaces, VS Code, and Docker, see the https://developer.aitrios.sony-semicon.com/en/file/download/sdk-getting-started/["**SDK Getting Started**"]. + 
...
IMPORTANT: See the "Issuing a Client Secret for SDK" in https://developer.aitrios.sony-semicon.com/en/file/download/portal-user-manual["**Portal User Manual**"] for how to get client ID and secret. + 
