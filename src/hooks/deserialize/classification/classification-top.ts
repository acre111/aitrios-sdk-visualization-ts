...
export class ClassificationTop {
  ...
  static getSizePrefixedRootAsClassificationTop (bb: flatbuffers.ByteBuffer, obj?: ClassificationTop): ClassificationTop {
    bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH)
    return (obj || new ClassificationTop()).__init(bb.readInt32(bb.position()) + bb.position(), bb)
  }

  perception (obj?: ClassificationData): ClassificationData | null {
    const offset = this.bb!.__offset(this.bb_pos, 4)
    return offset ? (obj || new ClassificationData()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null
  }
  ...
  static finishSizePrefixedClassificationTopBuffer (builder: flatbuffers.Builder, offset: flatbuffers.Offset) {
